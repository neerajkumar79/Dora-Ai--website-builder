...
const WebsiteEditor = () => {
    ...
    try {
         const result = await axios.get(`/api/website/deploy/${website._id}`,{withCredentials:true})
    ...
    const handleUpdate = async () => {
        ...
        try {
            const result = await axios.post(`/api/website/update/${id}`, { prompt }, { withCredentials: true })
    ...
    useEffect(() => {
        const handleGetWebsite = async () => {
            try {
                const result = await axios.get(`/api/website/getbyid/${id}`, { withCredentials: true })
